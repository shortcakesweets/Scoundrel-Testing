...
If you choose to flee, all 4 cards on the table will be restacked at the bottom of the dungeon.
Then, 4 new cards will be drawn.

You may not flee 2 rooms in a row.

### Fight

If you choose to fight, you should interact with 3 cards.
After that, 3 new cards are drawn and creates a new room.
The 1 card remaining follows you to the next room.
...
The damage that you take is the enemy rank - weapon rank, minimum 0.

However, killing an enemy with a weapon makes it dull.
You can use a weapon to an enemy only when it has lower rank than the last enemy that you've killed with that weapon.
...
(Only in Scoundrel+)
These are repair kits. When used, it will remove the last enemy that you've killed from your weapon.
...
You may only drink 1 potion in a room - that includes poison potions!
Any potions consumed after will fizzle and have no effect.
